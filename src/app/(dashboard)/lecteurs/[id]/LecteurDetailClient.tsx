...
export function LecteurDetailClient({ lecteurId, lecteur }: LecteurDetailClientProps) {
  ...
  return (
    <div className="min-h-screen pb-16">
      <LecteurCarteProvider lecteur={lecteur}>
        <div className="relative mb-6 overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
          ...
          <div className="flex items-center justify-between gap-2 border-b border-slate-100 px-4 py-2.5 sm:px-5">
            <Link
              href="/lecteurs"
              className="inline-flex h-9 items-center gap-2 rounded-full border border-slate-200 bg-white px-3.5 text-xs font-semibold text-slate-500 shadow-sm transition-all hover:bg-slate-50 hover:text-slate-800 group"
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-center lg:gap-6">
            <div className="flex min-w-0 flex-1 flex-col gap-4 sm:flex-row sm:items-start">
              <div className="relative mx-auto shrink-0 sm:mx-0">
                <Avatar className="h-20 w-20 border-[3px] border-white shadow-lg shadow-amber-900/10 ring-1 ring-slate-200/70">
                  {avatarSrc && <AvatarImage src={avatarSrc} alt="" className="object-cover" />}
                  <AvatarFallback className="bg-gradient-to-br from-amber-700 to-amber-900 text-xl font-extrabold text-white">
                    {initials}
                  </AvatarFallback>
                </Avatar>
                <span
                  className={`absolute bottom-0.5 right-0.5 h-4 w-4 rounded-full border-2 border-white shadow-sm ${
                    lecteur.sexe === "M" ? "bg-blue-400" : "bg-pink-400"
                  }`}
                  title={lecteur.sexe === "M" ? "Masculin" : "Féminin"}
                />
              </div>

              <div className="min-w-0 flex-1 space-y-3 text-center sm:text-left">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-amber-800/70">Fiche lecteur</p>
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-3">
                  <div className="flex items-center gap-2 rounded-xl border border-amber-100 bg-amber-50/60 px-2.5 py-2">
                    <Hash className="h-3.5 w-3.5 shrink-0 text-amber-800" />
                    <div className="min-w-0">
                      <p className="text-[9px] font-bold uppercase tracking-wider text-amber-700/70">Matricule</p>
                      <p className="truncate font-mono text-xs font-bold text-amber-950">{lecteur.uniqueId}</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 rounded-xl border border-slate-100 bg-slate-50/80 px-2.5 py-2">
                    <BadgeCheck className="h-3.5 w-3.5 shrink-0 text-amber-800" />
                    <div className="min-w-0">
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Grade</p>
                      <p className="truncate text-xs font-semibold text-slate-900">{grade}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 rounded-xl border border-slate-100 bg-slate-50/80 px-2.5 py-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Âge</p>
                  ...
                  <div className="flex items-center gap-2 rounded-xl border border-slate-100 bg-slate-50/80 px-2.5 py-2">
                    <Church className="h-3.5 w-3.5 shrink-0 text-amber-800" />
                    <div className="min-w-0">
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Paroisse</p>
                      <p className="truncate text-xs font-medium text-slate-800">{paroisse}</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 rounded-xl border border-slate-100 bg-slate-50/80 px-2.5 py-2">
                    <Map className="h-3.5 w-3.5 shrink-0 text-amber-800" />
                    <div className="min-w-0">
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Vicariat</p>
                      <p className="truncate text-xs font-medium text-slate-800">{vicariat}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex shrink-0 justify-center border-t border-slate-100 pt-4 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
      ...
      <div className="mb-6 flex w-fit gap-1 rounded-2xl bg-slate-100 p-1">
        {([
